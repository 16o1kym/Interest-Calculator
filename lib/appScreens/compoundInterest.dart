...
class _CompoundInterestState extends State<CompoundInterest> {
  ...
  String _calculateTotalReturns() {
    ...
    double totalAmountPayable = principal + pow((1 + (roi/12)) , 12*term);

    String result =
        "After $term years, your investment will be worth $totalAmountPayable $_currentItemSelected if compounded every month!";
    return result;
  }
